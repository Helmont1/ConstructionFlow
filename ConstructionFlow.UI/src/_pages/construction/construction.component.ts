...
export class ConstructionComponent {
  ...
  constructor(private statusService: StatusService, private constructionService: ConstructionService, private formBuilder: FormBuilder, private activitiService: ActivityService) {
